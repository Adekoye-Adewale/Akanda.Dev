...
export const Medium = () => {
    const handleMediumShare = () => {
        const url = encodeURIComponent(window.location.href);
        const mediumShareUrl = `https://medium.com/new-story?url=${url}`;
        window.open(mediumShareUrl, '_blank');
        };
    return (
        <Icon>
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg"  onClick={handleMediumShare}>
                <rect width="44" height="44" rx="22" fill="black"/>
